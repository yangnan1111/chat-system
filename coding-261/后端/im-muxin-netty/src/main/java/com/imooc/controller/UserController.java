...
//	public IMoocJSONResult register(@RequestBody SmsCode smscode, @RequestBody Users user, @RequestParam String phone) throws Exception {
//
//		// 0. 判断用户名和密码不能为空
//		if (StringUtils.isBlank(smscode.getPhone()) ){
//			return IMoocJSONResult.errorMsg("用户名不能为空");
//		}
//		if(StringUtils.isBlank(smscode.getCode()) ){
//			return IMoocJSONResult.errorMsg("验证码不能为空");
//		}
//		if(StringUtils.isBlank(smscode.getPassword()) ){
//			return IMoocJSONResult.errorMsg("密码不能为空");
//		}
//		// 1. 判断用户名是否存在，如果存在就登录，如果不存在则注册
//		boolean usernameIsExist = smsUserService.selectByPhone(phone);
//		Users userResult = null;
//		if (usernameIsExist==false) {
//			user.setNickname(user.getUsername());
//			user.setFaceImage("");
//			user.setFaceImageBig("");
//			smscode.setPassword(MD5Utils.getMD5Str(smscode.getPassword()));
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
	 ...
	 */
	@PostMapping("/search")
	public IMoocJSONResult searchUser(String myUserId, String friendPhone)
			throws Exception {
	...
	public IMoocJSONResult addFriendRequest(String myUserId, String friendPhone)
			throws Exception {
